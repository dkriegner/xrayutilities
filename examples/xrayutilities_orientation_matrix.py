...
"""
example to show how to calculate the orientation matrix U from one symmetric and
one asymmetric diffraction peak. The orientation matrix can be used in the reciprocal
space conversion to correct the experimental alignment of the crystal.
...
steps 1 and 3 are performed (this depends on the source of data you have)
"""

import numpy
import xrayutilities as xu

# lets assume in step 1) we found the reciprocal space positions of a GaAs crystal
# as

qsym = (0.01822137,-0.013112,4.45427) # (004) peak
qasym = (0.0173859,1.56126512,3.3450612) # (113) peak

# the goal is to correct to the diffraction positions in a way that the symmetric peak
# is located on the z-axis and the asymmetric peak is located in either the x/z or y/z plane
...
# now lets correct the sample azimuth in order to have the asymmetric peak in the
# x/z plane, again we make use of coordinate transformations in xrayutilities
