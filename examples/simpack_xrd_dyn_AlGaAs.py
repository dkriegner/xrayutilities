...
scan = xu.io.panalytical_xml.XRDMLFile(
    "simpack_xrd_AlGaAs.xrdml.gz", path="data"
)
...
AlGaAs80_1 = xu.simpack.Layer(AlGaAs80, 20000, relaxation=0.0)
GaAs_2 = xu.simpack.Layer(GaAs_, 2000, relaxation=0.0)
AlGaAs80_3 = xu.simpack.Layer(AlGaAs80, 18000, relaxation=0.0)
GaAs_4 = xu.simpack.Layer(GaAs_, 3200, relaxation=0.0)


# heterostructure content
heterostructure = xu.simpack.PseudomorphicStack001(
    "Hetereostructure", sub, AlGaAs80_1 + GaAs_2 + AlGaAs80_3 + GaAs_4
)

# Monochromator
thMono = np.arcsin(
    xu.wavelength("CuKa1") / (2 * xu.materials.Ge.planeDistance(2, 2, 0))
)
...
fitmdyn.set_param_hint(
    "AlAs_0_80_GaAs_0_20__c", vary=True, min=AlGaAs80.a, max=AlGaAs80.a * 1.002
)
fitmdyn.set_param_hint(
    "AlAs_0_80_GaAs_0_20__thickness", vary=True, min=19800, max=20200
)
...
fitmdyn.set_param_hint(
    "AlAs_0_80_GaAs_0_20__1_c", vary=True, expr="AlAs_0_80_GaAs_0_20__c"
)
# 18000/20000 :  thickness ratio between layer 1 and 3
fitmdyn.set_param_hint(
    "AlAs_0_80_GaAs_0_20__1_thickness",
    vary=True,
...
fitmdyn.set_param_hint(
    "GaAs_2_thickness", vary=True, expr="GaAs_1_thickness*3200/2000"
)
...
plt.text(
    ...
    "GaAs: {:.1f} nm \nGaAl$_{{{:.2f}}}$As: {:.0f} nm \nGaAs: {:.1f} nm \
         \nGaAl$_{{{:.2f}}}$As: {:.0f} nm \nSubstrate".format(
        fitr.params["GaAs_2_thickness"] / 10,
        x_Al,
        fitr.params["AlAs_0_80_GaAs_0_20__1_thickness"] / 10,
        fitr.params["GaAs_1_thickness"] / 10,
        x_Al,
