...
def getindex3d(x,y,z,xgrid,ygrid,zgrid):
    ...
    #if(ix<0 or ix>xgrid.size): print("Warning: point (%8.4f, %8.4f, %8.4f) out of range in x coordinate!"%(x,y,z))
    #if(iy<0 or iy>ygrid.size): print("Warning: point (%8.4f, %8.4f, %8.4f) out of range in y coordinate!"%(x,y,z))
    #if(iz<0 or iz>zgrid.size): print("Warning: point (%8.4f, %8.4f, %8.4f) out of range in z coordinate!"%(x,y,z))
