...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.mathjax', 'sphinx.ext.viewcode','rst2pdf.pdfbuilder']
...
copyright = u'2014, Dominik Kriegner, Eugen Wintersberger'
...
texinfo_documents = [
  ('index', 'xrayutilities', u'xrayutilities Documentation',
   u'Dominik Kriegner, Eugen Wintersberger', 'xrayutilities', 'a Python package for diffraction physicists',
   'Miscellaneous'),
]
...
pdf_documents = [
 ('index', u'xrayutilities', u'xrayutilities', u'Dominik Kriegner\\Eugen Wintersberger'),]
...
# parameter list of functions should be found and changed to be properly formated in the output
import re
def process_docstring(app, what, name, obj, options, lines):
    ...
    for i in range(len(lines)):
        ...
        # parameter names
        lines[i] = re.sub(r'^(\s*)([\w,()]+)(\s*:|\s{2,}|\s\.{1,}\s)',r'\1:\2: ',lines[i])
        # section names (multiline matching)
        if re.match('^\s*-{3,}\s*$',lines[i]):
            try:
                lines[i] = re.sub(r'^([a-zA-Z0-9_,:\s]*)',r'\1:',lines[i-1])
                lines[i] = ' '
            except: pass
