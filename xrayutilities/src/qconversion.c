    ...
    *   */
{
    ...
    double *sampleAngles, *detectorAngles, *ri, *kappadir, *UB, *qpos;
    npy_intp nout[2];
    ...
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!O!dI",
    ...
    *   */
{
    ...
    double *sampleAngles,*detectorAngles, *ri, *kappadir, *sampledis,
           *UB, *qpos;  /* c-arrays for further usage */
    npy_intp nout[2];
    /* arrays with function pointers to rotation matrix functions */
    fp_rot *sampleRotation;
    fp_rot *detectorRotation;
    ...
    /* Python argument conversion code */
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!O!O!dI",
                          &PyArray_Type, &sampleAnglesArr,
                          &PyArray_Type, &detectorAnglesArr,
                          &PyArray_Type, &riArr,
                          &sampleAxis, &detectorAxis,
    ...
    *   */
{
    ...
    unsigned int nthreads;  /* number of threads to use */
    double f, lambda, cch, dpixel, tilt;  /* x-ray wavelength, f=M_2PI/lambda
                                           * and detector parameters */
    char *sampleAxis, *detectorAxis, *dir;  /* string with sample and
                                             * detector axis, and detector
                                             * direction */
    double *sampleAngles, *detectorAngles, *rcch, *kappadir, *UB, *qpos;
    ...
    /* Python argument conversion code */
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!ddO!sdO!dI",
                          &PyArray_Type, &sampleAnglesArr,
                          &PyArray_Type, &detectorAnglesArr,
    ...
    *   */
{
    ...
    int Nch;  /* number of channels in region of interest */
    unsigned int nthreads;  /* number of threads to use */
    double f, lambda, cch, dpixel, tilt;  /* wavelength and detector
                                           * parameters */
    char *sampleAxis, *detectorAxis, *dir;  /* string with sample and
                                             * detector axis, and
                                             * detector direction */
    ...
    /* Python argument conversion code */
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!ddO!sdO!O!dI",
                          &PyArray_Type, &sampleAnglesArr,
                          &PyArray_Type, &detectorAnglesArr,
                          &PyArray_Type, &rcchArr,
                          &sampleAxis, &detectorAxis,
    ...
    *   */
{
    ...
    /* Python argument conversion code */
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!ddddO!ssddO!dI",
                          &PyArray_Type, &sampleAnglesArr,
                          &PyArray_Type, &detectorAnglesArr,
                          &PyArray_Type, &rcchArr,
                          &sampleAxis, &detectorAxis,
    ...
    *   */
{
    ...
    double *sampleAngles,*detectorAngles, *rcch, *kappadir, *UB, *sampledis,
           *qpos;  /* c-arrays for further usage */
    int *roi;  /* region of interest integer array */
    fp_rot *sampleRotation;
    fp_rot *detectorRotation;
    npy_intp nout[2];
    ...
    /* Python argument conversion code */
    if (!PyArg_ParseTuple(args, "O!O!O!ssO!ddddO!ssddO!O!dI",
                          &PyArray_Type, &sampleAnglesArr,
                          &PyArray_Type, &detectorAnglesArr,
                          &PyArray_Type, &rcchArr,
                          &sampleAxis, &detectorAxis,
