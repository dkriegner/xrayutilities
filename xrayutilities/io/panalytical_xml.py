...
class XRDMLMeasurement(object):
    ...
    def __init__(self, measurement):
        ...
        slist = measurement.getElementsByTagName("scan")
        ...
        for s in slist:
            ...
            if scanstatus == "Aborted" and len(slist) > 1:
                ...
                countTime = points.getElementsByTagName(
                    "commonCountingTime")[0].childNodes[0].nodeValue
                ...
                data_list = (numpy.fromstring(data.nodeValue, sep=" ") /
                ...
                for p in pos:
                    ...
                    if len(l) != 0:  # listPositions
                        ...
                        data_list = numpy.linspace(
                            float(s[0].childNodes[0].nodeValue),
                            float(e[0].childNodes[0].nodeValue),
                            nofpoints).tolist()
                    else:  # commonPosition
